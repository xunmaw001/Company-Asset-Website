...
public class ZichanBaofeiView extends ZichanBaofeiEntity implements Serializable {
	...
	* 资产报废类型的值
	*/
	@ColumnInfo(comment="资产报废类型的字典表值",type="varchar(200)")
	private String zichanBaofeiValue;
	...
	* 获取： 资产报废类型的值
	*/
	public String getZichanBaofeiValue() {
		return zichanBaofeiValue;
	}
	/**
	* 设置： 资产报废类型的值
	*/
	public void setZichanBaofeiValue(String zichanBaofeiValue) {
		this.zichanBaofeiValue = zichanBaofeiValue;
	}
	...
	public String toString() {
		return "ZichanBaofeiView{" +
			", zichanBaofeiValue=" + zichanBaofeiValue +

        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gongsizichan/upload/yuangongMuBan.xls"
                        >批量导入员工数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yuangong','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column label="工号" prop="yuangongUuidNumber" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="员工身份证号" prop="yuangongIdNumber" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.yuangongIdNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column label="员工头像" prop="yuangongPhoto" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center" width="200">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="部门" prop="bumenTypes" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.bumenValue}}
                        </template>
                    </el-table-column>
                    <el-table-column label="职位" prop="zhiweiTypes" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.zhiweiValue}}
                        </template>
                    </el-table-column>
                    <el-table-column label="员工邮箱" prop="yuangongEmail" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
